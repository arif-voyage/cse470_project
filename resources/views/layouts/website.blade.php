      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-4 site-logo">
            <a href="index.html" class="text-black h2 mb-0">Amaze Latte</a>
          </div>
    ...
    <div class="site-footer">
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-4">
            <div>
              <h3 class="footer-heading mb-4">Connect Us</h3>
              <p>
        ...
        <div class="row">
          <div class="col-12 text-center">
            <p>
              ...
              <div class="mb-0">By Ariful Islam <a href="https://laravel.com/docs/7.x">Developed Using Laravel Framework </a>Motivation -> Tutorial Series by Zakir</div>
              </p>
          </div>
        </div>
      </div>
