    ...
    <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('{{ asset('website') }}/images/img_4.jpg');">
        ...
        <div class="row same-height justify-content-center">
            ...
            <div class="post-entry text-center">
                ...
                <p class="lead mb-4 text-white">We are blogging site for coffee lovers</p>
            </div>
            </div>
        </div>
        </div>
    ...
    <div class="site-section bg-white">
        ...
        <div class="row justify-content-center text-center">
            ...
            <div class="subscribe-1 ">
                ...
                <p class="mb-5">Don't wait subscribe now to get updates and promotional messages from us. Stay connected 
                    Drop your email here to get started.</p>
